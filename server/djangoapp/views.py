...
def get_cars(request):
    # Count existing CarMake entries; if none exist, populate the data.
    count = CarMake.objects.all().count()
    print("Number of CarMake entries:", count)
    if count == 0:
        initiate()
    # Get all CarModel instances along with their related CarMake
